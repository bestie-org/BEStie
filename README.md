...
1. Get BEStie firmware .hex from [release page](https://github.com/bestie-org/BEStie/releases/latest):
   | Board | Firmware file |
   |-------|-------|
   | nRF52-DK / generic nRF52832 board powered from coin cell| [bestie_nrf52832_generic.hex](https://github.com/bestie-org/BEStie/releases/latest/download/bestie_nrf52832_generic.hex) |
   | nRF52840-DK / generic nRF52840 board powered from coin cell|  [bestie_nrf52840_generic.hex](https://github.com/bestie-org/BEStie/releases/latest/download/bestie_nrf52840_generic.hex) |
   | Adafruit Feather family (Express, Sense, BLE) |  [bestie_nrf52840_feather.hex](https://github.com/bestie-org/BEStie/releases/latest/download/bestie_nrf52840_feather.hex) |
   | Seed Studio Xiao family (BLE, BLE Sense) |  [bestie_nrf52840_xiao.hex](https://github.com/bestie-org/BEStie/releases/latest/download/bestie_nrf52840_xiao.hex) |
